...
class QuantumStateVector {
  public:
    ...
    void applyControlledModMul(int control_qubit, int work_start, int work_qubits, uint64_t mult,
                               uint64_t modulus);
  ...
  private:
    ...
    Eigen::MatrixXcd kronecker(const Eigen::MatrixXcd& A, const Eigen::MatrixXcd& B) const;
