...
Eigen::Matrix2cd hadamard() {
    Eigen::Matrix2cd H;
    H << Cd(INV_SQRT2, 0), Cd(INV_SQRT2, 0), Cd(INV_SQRT2, 0), Cd(-INV_SQRT2, 0);
    return H;
}

Eigen::Matrix2cd pauliX() {
    Eigen::Matrix2cd X;
    X << Cd(0, 0), Cd(1, 0), Cd(1, 0), Cd(0, 0);
    return X;
}

Eigen::Matrix2cd pauliY() {
    Eigen::Matrix2cd Y;
    Y << Cd(0, 0), Cd(0, -1), Cd(0, 1), Cd(0, 0);
    return Y;
}

Eigen::Matrix2cd pauliZ() {
    Eigen::Matrix2cd Z;
    Z << Cd(1, 0), Cd(0, 0), Cd(0, 0), Cd(-1, 0);
    return Z;
}

Eigen::Matrix2cd phase(double theta) {
    Eigen::Matrix2cd R;
    R << Cd(1, 0), Cd(0, 0), Cd(0, 0), std::polar(1.0, theta);
    return R;
}
